...
- question: What does the phrase 'edge to core to cloud' generally refer to?
  answer: Depending on the context, the phrase refers to the various locations where
    ...
    the source of data, 'core' refers to on-premises data center s or private clouds,
...
- ```Core``` usually refers to on-premises data center s which could mean a cloud computing model that would probably be described as a *private cloud*.
...
| Core | Central data center s or colocation of IT infrastructure |
