...
tags: [WTF]
faq:
- question: What is the primary security concern regarding 'AI sprawl'?
  answer: AI sprawl refers to users inadvertently sharing sensitive information, such
    as usernames, passwords, identity details, and source code, within AI prompts,
    which can lead to unauthorized access or token misuse.
- question: How will enterprise AI agents change how employees interact with software?
  answer: Enterprises are shifting toward agentic AI that handles task-specific duties.
    Instead of logging into individual software UIs, employees will use a 'conversational
    harness' to interpret their chat or voice commands to perform tasks.
- question: What is the 'playbook gap' in automation lifecycles?
  answer: The playbook gap occurs when the original creator of an automation playbook
    leaves an organization, leaving the successor to deal with 'drift' and a lack
    of context, which can cause automation to fail or result in the accidental exposure
    of private data.
---
