...
tags: [WTF]
faq:
- question: What is the author's primary goal for their future recording setup?
  answer: The author aims to create a mobile-friendly setup that requires minimal
    equipment and fits into a backpack, potentially including a dedicated microphone
    for their iPhone.
- question: How does the author define the shift from 'prompt engineering' to 'context
    engineering'?
  answer: The author describes 'context engineering' as a higher-level abstraction
    that goes beyond simple prompting by focusing on identifying who is asking, their
    specific role, and what their ultimate goal is.
- question: What does the author suggest regarding the future of AI on mobile devices?
  answer: The author envisions a future where personal AI assistants run locally on
    devices, providing private and secure compute without needing to rely on generalized
    infrastructure or remote data centers.
---
