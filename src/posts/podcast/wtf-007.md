...
tags: [WTF, quantum]
faq:
- question: What does the author identify as a key observation regarding autonomous
    vehicles during their trip to San Francisco?
  answer: The author noted a surprising saturation of Waymo autonomous vehicles on
    the 101 highway, noting that this technology has progressed from simple city or
    non-highway environments to pervasive use on major highways.
- question: What is the shift from 'BICC' to 'BIPC' described in the context of Agentic
    AI?
  answer: BICC refers to a Business Intelligence Center of Confidence, whereas BIPC
    refers to a Business Intelligence Person of Confidence. The author notes that
    while a BIPC approach focuses on a specific individual, it is not a scalable operation
    compared to a true center of competence.
- question: How is the focus of SpaceX changing as it prepares for an IPO?
  answer: As SpaceX prepares for an intensive IPO buildup, the company is shifting
    its focus toward AI and other moonshots, while the original goal of reaching Mars
