...
- question: What is the source of the links provided in the post?
  answer: The links are selected from dozens of Slack communities the author reviews.
- question: Are the links provided in the post safe for work?
  answer: Yes, the author explicitly states that this will always be a safe for work
    list.
---
