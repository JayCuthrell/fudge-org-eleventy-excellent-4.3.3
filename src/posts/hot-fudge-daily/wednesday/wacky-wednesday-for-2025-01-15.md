...
- question: Are the links provided in the posts suitable for the workplace?
  answer: Yes, the author ensures that the list of shared links is always safe for
    work.
- question: Where does the author find the links to share?
  answer: The author finds the shared links by going through dozens of Slack communities.
---
