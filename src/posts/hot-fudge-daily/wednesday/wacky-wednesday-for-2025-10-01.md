...
- question: What is the concept of the 'choose your own adventure' movie described
    by the filmmaker?
  answer: The concept involves a movie where the script dynamically tailors itself
    based on the viewer's choices and preferences.
- question: What elements influence the dynamic script in the proposed AI-driven movie
    format?
  answer: The prompt is influenced by the viewer's taste graph, which acts as a memory,
    and storytelling junction inputs known as HITL (Human-In-The-Loop).
- question: What is the author currently doing regarding their older online content?
  answer: The author is slowly updating their older content to transition the formatting
