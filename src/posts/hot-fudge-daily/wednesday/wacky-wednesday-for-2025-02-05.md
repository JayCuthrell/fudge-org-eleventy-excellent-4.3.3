...
- question: When does the author curate the list of links?
  answer: The author goes through Slack communities and selects interesting links
    every Wednesday.
- question: What kind of content can readers expect in the list?
  answer: The list consists of interesting links shared in Slack communities that
    are guaranteed to be safe for work.
