...
- question: What is the primary focus of AST SpaceMobile and Nextnav according to
    the author's thesis?
  answer: The author suggests that AST SpaceMobile and Nextnav are focused on new
    connectivity and precision location infrastructure.
- question: Which company listed in the screener experienced the highest percentage
    change?
  answer: AST SpaceMobile, Inc. (ASTS) experienced the highest percentage change at
    +5.88%.
- question: What are the three companies listed in the provided stock screener?
  answer: The three companies listed are AST SpaceMobile, Inc. (ASTS), Roblox Corporation
    (RBLX), and Nextnav Inc. (NN).
---
