...
- question: What is the current status of the NASDAQ?
  answer: The NASDAQ is currently around 19K, though it is expected to likely reach
    20K soon.
- question: Where can the data comparing egg prices to Bitcoin be found?
  answer: The data comparing the average price of Grade A large eggs to Bitcoin is
    available via the Federal Reserve Economic Data (FRED) website.
---
### New Recap
