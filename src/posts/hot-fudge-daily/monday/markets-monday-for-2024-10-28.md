...
- question: What resource does the author use to track key market indicators for Market
  ...
  answer: The author uses a simple Yahoo Finance webpage to view key market indicators
    at the closing bell each Monday.
- question: How can readers save their own specific heat map view on Yahoo Finance?
...
- question: What specific criteria are used for the Yahoo Finance stock screener mentioned
    in the post?
  answer: The criteria include an intraday price change greater than 4%, a United
    States region, Mid/Large/Mega Market Cap, price greater than or equal to 5, volume
    over 15,000, and a focus on specific Technology sectors and industries.
---
### Quick Recap
