...
*(The* [*elephant in the room is blue*](https://www.techmeme.com/240719/p2#a240719p2) *and it is a Friday when I write this update. So, I’ll update that topic in 🗞️ Sneak Peak Saturday.)*
...
$ git diff -- app/controllers/auth/sessions\_controller.rb

def home\_paths(resource)- paths = [about\_path, '/explore']+ paths = [about\_path, '/about']

paths << short\_account\_path(username: resource.account) if single\_user\_mode? && resource.is\_a?(User)
