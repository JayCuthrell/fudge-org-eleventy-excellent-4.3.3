...
- question: How does the size of a recent DDoS attack mentioned in the post compare
  ...
  answer: A recent DDoS attack reached approximately 5.6 Tbps, whereas the 2013 attack,
    which was described as having 'almost broken the Internet,' reached only about
    0.085 Tbps.
- question: What factors does the author suggest have changed since 2013 regarding
    DDoS attacks?
  answer: The author suggests that mitigation techniques and the expansion of the
    Cloudflare business have likely changed since 2013.
- question: What does the author speculate about the future of DDoS data claims?
  answer: The author wonders if future claims will relate to the theoretical throughput
    of modern multi-Tbps Ethernet switch slots or collections of switches at fully
    populated capacity.
---
