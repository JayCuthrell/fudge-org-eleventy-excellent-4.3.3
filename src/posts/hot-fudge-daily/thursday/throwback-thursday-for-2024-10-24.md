...
faq:
- question: What was the price of the computer mentioned from 2011?
  answer: The computer mentioned from 2011 cost $25.
- question: What is the price of the current Raspberry Pi model mentioned?
  answer: The current Raspberry Pi model mentioned is priced at $110.
- question: What is the processing capability of the current Raspberry Pi model?
  answer: The current Raspberry Pi model features a 26 tera-operations per second
    (TOPS) capability.
---
