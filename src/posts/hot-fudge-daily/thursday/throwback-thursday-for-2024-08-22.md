...
tags: [quantum]
faq:
- question: What is the purpose of the Throwback Thursday segment?
  answer: Throwback Thursday is a feature that examines prior predictions or past
    news coverage to see how they have played out in the present.
- question: What is the origin of the Throwback Thursday format?
  answer: Throwback Thursday is based on the classic Fudge Sunday Weekly newsletter
    sections known as Shot and Chaser.
- question: Why is the Sky ECC story relevant to current discussions on encryption?
  answer: The Sky ECC story is relevant because it highlights the ongoing challenges
    of accessing encrypted messages years later, which parallels current concerns
    regarding Y2Q and the future of post-quantum cryptography.
---
