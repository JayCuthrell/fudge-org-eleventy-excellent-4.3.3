...
date: 2024-03-07
faq:
- question: How will the author be sharing updates from SXSW 2024?
  answer: Instead of live blogging or posting in real-time, the author will periodically
    update their 'Notes Before SXSW 2024' post throughout the nine days of the event
    and send a final summary in a regular Fudge Sunday newsletter update.
- question: What is the author's professional affiliation at SXSW 2024?
  answer: The author works for IBM, which is sponsoring the Artificial Intelligence
    track at the conference.
- question: How can readers meet up with the author during the event?
  answer: Readers can review the author's SXSW 2024 schedule picks to find potential
    sessions to attend together or use the author's Calendly link to arrange a time
    to catch up.
---
